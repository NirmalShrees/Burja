      ...
      >
                    ...
                    {publicRooms.map((room) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="py-1.5 px-3.5 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-bold text-xs shadow-md border border-amber-300/60 transition-all shrink-0 active:scale-95 disabled:opacity-50 cursor-pointer"
                        >
        ...
        <div className="mt-3 pt-2 border-t border-slate-800/80 text-center shrink-0">
          <p className="text-[10px] text-slate-400 font-mono flex items-center justify-center gap-1.5">
            ...
            <span>Up to 20 players per table</span>
          </p>
        </div>
      </div>
    </div>
